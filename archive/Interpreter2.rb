=begin
Modified 10/04/2014 to remove presence of global variable $declared
Was a bit bored and tired of the one thing stopping the project
from being a true Class Separation
-------------------------------------------------------------------------------
